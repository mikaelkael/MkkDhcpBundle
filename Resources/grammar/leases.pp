...
%token authoringByteOrder authoring-byte-order
%token authoringByteOrderLittleEndian little-endian
%token vendorClassIdentifier vendor-class-identifier
...
#leaseFile:
    ( comment() | lease() | failOverPeer() | serverDuid() | authoringByteOrder() )*
...
#variableName:
    <ddnsTxt> | <ddnsFwdName> | <ddnsClientFqdn> | <ddnsRevName> | <vendorClassIdentifier>
...
#authoringByteOrder:
    ::authoringByteOrder:: ::authoringByteOrderLittleEndian:: ::semicolon::
